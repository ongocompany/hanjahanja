...
- 필수: 이메일 주소, 비밀번호(암호화 저장), 전화번호
- 자동 수집: 학습 기록, 서비스 이용 기록, 접속 로그

2. 개인정보의 수집·이용 목적
- 회원 식별 및 가입 의사 확인
- 서비스 제공 및 학습 진도 관리
- AI 모델(WSD) 개선을 위한 학습 데이터 활용
- 서비스 개선을 위한 통계 분석
- 고지사항 전달, 불만 처리, 분쟁 조정
...
개인정보 수집·이용에 대한 동의를 거부할 수 있으며, 거부 시 회원가입이 제한됩니다.`,
  },
  {
    id: "thirdParty",
    label: "제3자 정보제공 동의",
    content: `1. 개인정보를 제공받는 자 및 제공 항목

① Supabase Inc. (클라우드 인프라 제공)
- 제공 항목: 이메일, 암호화된 비밀번호, 서비스 이용 기록
- 목적: 회원 인증, 데이터 저장 및 보안 관리
- 보유 기간: 회원 탈퇴 시까지

② Google LLC (소셜 로그인 이용 시)
- 제공 항목: OAuth 인증 토큰
- 목적: 간편 로그인 인증
- 보유 기간: 연동 해제 시까지
